...
<head>
  ...
  <title data-ice="title">node_modules/acorn/dist/acorn.js | nstructjs</title>
...
<div class="content" data-ice="content"><h1 data-ice="title">node_modules/acorn/dist/acorn.js</h1>
<pre class="source-code line-number raw-source-code"><code class="prettyprint linenums" data-ice="content">(function (global, factory) {
  ...
  var defaultOptions = {
    ...
    // callbackb that will corrupt its internal state.
    onToken: null,
    ...
    // parser from the callbackb that will corrupt its internal state.
    onComment: null,
  ...
  // Verify that a node is an lval b  something that can be assigned
  // to.
  ...
  // Object/class getters and setters are not allowed to clash b 
  // either with each other or with an init property b  and in
  ...
  // Parse an atomic expression b  either a single token that is an
  ...
  // be a `[]` or dot subscript expression, but not a call b  at least,
