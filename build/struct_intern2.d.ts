import { TypeDescriptor, StructField, StructFieldTypeClass, StructManager, UnpackContext, FieldTypeDefinition, TokSymbolRet } from "./types.js";
...
export declare function packNull(manager: StructManager, data: PackBuffer, field: StructField, type: TypeDescriptor): void;
...
export declare function validateJSON(manager: StructManager, val: unknown, obj: unknown, field: StructField, type: TypeDescriptor, instance: unknown, _abstractKey?: string): TokSymbolRet;
export declare function do_pack(manager: StructManager, data: PackBuffer, val: unknown, obj: unknown, field: StructField, type: TypeDescriptor | number): void;
export declare class StructFieldType {
    static pack(manager: StructManager, data: PackBuffer, val: unknown, obj: unknown, field: StructField, type: TypeDescriptor): void;
    ...
    static validateJSON(manager: StructManager, val: unknown, obj: unknown, field: StructField, type: TypeDescriptor, instance: unknown, _abstractKey?: string): TokSymbolRet;
    /**
