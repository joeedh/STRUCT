...
var STRUCT = _module_exports_$1.STRUCT = class STRUCT {
  constructor() {
  ...
  parse_structs(buf, defined_classes) {
    ...
    if (defined_classes == undefined) {
      defined_classes = [];
      for (var k in _module_exports_$1.manager.struct_cls) {
...
var manager = _module_exports_$1.manager = new STRUCT();
 ...
 * */
var write_scripts = _module_exports_$1.write_scripts = function write_scripts(manager, include_code = false) {
...
var _require___$tinyeval$tinyeval_js_ = /*#__PURE__*/Object.freeze({
  __proto__: null,
  acorn: _export_acorn_,
  walk: _export_walk_,
  color: color,
  'eval': _export_eval_
});
...
_module_exports_$2.register = function register(cls, name) {
  return _module_exports_$2.manager.register(cls, name);
};
_module_exports_$2.inherit = function () {
...
_module_exports_$2.useTinyEval = function() {
  _nGlobal._structEval = (buf) => {
    return _module_exports_$2.tinyeval.eval(buf);
  };
};
//$BUILD_TINYEVAL_END
