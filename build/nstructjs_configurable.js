...
function termColor(s, c) {
  ...
  if (typeof c === "string" && c in colormap) {
    ...
    code3 = typeof c === "number" ? c : parseInt(c, 10);
  }
  if (code3 > 107) {
    const s2 = "\x1B[38;5;" + code3 + "m";
    return s2 + str + "\x1B[0m";
  }
  return "\x1B[" + code3 + "m" + str + "\x1B[0m";
}
...
var StructOptionalField = class extends StructFieldType {
  ...
  static validateJSON(manager2, val, obj, field, type, instance, _abstractKey) {
    ...
    return val !== void 0 && val !== null ? validateJSON(manager2, val, obj, fakeField, type.data, void 0, _abstractKey) : true;
  }
  static fromJSON(manager2, val, obj, field, type, instance) {
    const fakeField = this.fakeField(field, type);
...
function printCodeLines(code3) {
  const lines = code3.split(String.fromCharCode(10));
  let buf = "";
...
var code2 = `StructClass = class StructClass2 {
    ...
    for (const k in this.structs) {
      ...
      for (const field of stt.fields) {
        if (field.name === "this") {
          ...
          if (struct_parser.ValueTypes.has(type2)) {
  ...
  parse_structs(buf, defined_classes, version = 0) {
    ...
    const migrationSource = defined_classes instanceof STRUCT ? defined_classes : this;
    ...
    while (!struct_parse.at_end()) {
      ...
      if (!(migratedName in clsmap)) {
        ...
        dummy[keywords.script] = STRUCT.fmt_struct(stt, void 0, void 0, void 0, true);
        dummy[keywords.name] = stt.name;
        dummy.prototype[keywords.name] = dummy.name;
        dummy[util.PARSE_STRUCTS_DUMMY] = true;
  ...
  read_object(data, cls_or_struct_id, uctx, objInstance, rootVersion) {
    ...
    if (typeof cls_or_struct_id === "number") {
      ...
      if ((cls === void 0 || util.isParseStructsDummy(cls)) && this.onUnknownClass) {
